...
import { Container, Row, Col, Card, Form, CardGroup, Button} from 'react-bootstrap';
      ...
      <Container className="mt-5">
        <Row className="justify-content-sm-center">
          <Col
            ...
            lg={6}
            xl={5}
            className="col-xl-8 col-lg-8 col-md-7 col-sm-9 col-12"
          >
            <CardGroup>
              <Card variant="light" bg="light">
                ...
                <Card.Footer className="pr-0 my-0">
                  ...
                  <Link to="/" className="ms-auto">
                    <Button className="col-10 offset-1" variant="link"></Button>
                  </Link>
                </Card.Footer>
              </Card>
            </CardGroup>
